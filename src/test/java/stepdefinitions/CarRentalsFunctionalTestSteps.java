...
public class CarRentalsFunctionalTestSteps extends BaseStep {
	...
	public void theUserNavigatesToThePreviousPage() {
		...
		softAssertions.assertThat(isThisDealingPage)
			.as("Since the user clicks on the back button, should be moved to the previous page but does not")
			.isTrue();
	}
	...
	public void theUserShouldSeeTheViolationMessageAtTheBottomOfTheBox() {
		...
		softAssertions.assertThat(isViolationMessageDisplayed)
			.as("Since the user enters invalid card number the violation message should be displayed but does not")
			.isTrue();
	}
	...
	public void theUserValidatesWhetherAtTheCarRentalsCheckoutPage() {
		...
		softAssertions.assertThat(isThisCheckoutPage)
			.as("the user should validate the page as CheckoutPage but does not")
			.isTrue();
	}
